        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a class="nav-link" href="indexv2.php"><span class="fa fa-home fa-lg"></span> Home</a></li>
           ...
           <div class="col-12">
            ...
            <div class="col-12 col-sm-4 offset-sm-1">
                   <h5>Our Address</h5>
		            ...
		            Roadno.8A, Houseno.42, Keari Plaza<br>
            ...
            <div class="col-12 col-sm-6 offset-sm-1">
                ...
                <div class="container">
                                    <img src="img/image5.png" style="max-width: 400px">

                </div>
            </div>
            <div class="col-12 col-sm-11 offset-sm-1">
                <div class="btn-group" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+8801925779647"><i class="fa fa-phone"></i>Call</a>
                    <a role="button" class="btn btn-info" href=""><i class="fa fa-skype"></i>Skype</a>
                    <a role="button" class="btn btn-success" href="mailto:sakibhossain07@gmail.com"><i class="fa fa-envelope-o"></i>Email</a>
            ...
            <div class="col-12 col-md-9">
                <form action="../Controller/feedbackcontroller.php" method="POST">
                    ...
                    <div class="col-5 col-md-3">
                        <input type="tel" class="form-control" id="countrycode" name="countrycode" placeholder="Country Code">
                    </div>
